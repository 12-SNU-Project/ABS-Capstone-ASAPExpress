...
TERM_EXPANSION_MAP = {
    "국": ["soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "탕": ["soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "찌개": ["stew", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "미역국": ["seaweed soup", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "재첩국": ["clam soup", "shellfish soup", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    ...
    "오징어 무국": ["soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "김치 우동 전골": ["food preparations not elsewhere specified or included", "other food preparations", "miscellaneous edible preparations", "prepared meal", "prepared food"],
    "가자미구이": ["flatfish", "flounder", "prepared fish", "preserved fish"],
    "구운 가자미": ["flatfish", "flounder", "prepared fish", "preserved fish"],
    "대구매운탕": ["cod soup", "fish soup", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "대구탕": ["cod soup", "fish soup", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "동태탕": ["fish soup", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "알탕": ["fish roe soup", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "해물탕": ["seafood soup", "fish soup", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "곰탕": ["beef soup", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "북엇국": ["dried pollack soup", "fish soup", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "육개장": ["beef soup", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "삼계탕": ["chicken soup", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "콩나물국": ["bean sprout soup", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "황태해장국": ["dried pollack soup", "fish soup", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "해장국": ["soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "생선매운탕": ["fish soup", "soup", "soups", "broth", "broths", "prepared soup", "prepared soups"],
    "삼치구이": ["grilled fish", "prepared fish", "preserved fish"],
    "구운 삼치": ["grilled fish", "prepared fish", "preserved fish"],
    "갈치구이": ["grilled fish", "prepared fish", "preserved fish"],
    "구운 갈치": ["grilled fish", "prepared fish", "preserved fish"],
    "임연수구이": ["grilled fish", "prepared fish", "preserved fish"],
    "생선간편구이": ["grilled fish", "prepared fish", "preserved fish"],
    "조림 양념": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "볶음 양념": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "조리볶음 양념": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "갈치조림 양념": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "양념장": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    ...
    "간편 생선구이": ["prepared fish", "preserved fish", "grilled fish"],
    "생선구이 2종": ["prepared fish", "preserved fish", "grilled fish"],
    "간편 가자미구이": ["flatfish", "flounder", "sole", "prepared fish", "preserved fish"],
    "짜장면": ["other pasta", "prepared pasta", "prepared noodles", "pasta", "noodles"],
    "중화면": ["other pasta", "prepared pasta", "prepared noodles", "pasta", "noodles"],
    "짬뽕": ["other pasta", "prepared pasta", "otherwise prepared pasta", "prepared noodles", "noodles", "pasta"],
    "짬뽕면": ["other pasta", "prepared pasta", "otherwise prepared pasta", "prepared noodles", "noodles", "pasta"],
    "중화면": ["other pasta", "prepared pasta", "otherwise prepared pasta", "noodles", "pasta"],
    "숙면": ["prepared pasta", "otherwise prepared pasta", "cooked pasta", "noodles", "pasta"],
    "모둠나물면": ["uncooked pasta", "fresh pasta", "pasta", "noodles"],
    "나물면": ["uncooked pasta", "fresh pasta", "pasta", "noodles"],
    "설기": ["rice cake", "cakes", "pastry", "bakers wares", "bakers' wares"],
    "백설기": ["rice cake", "cakes", "pastry", "bakers wares", "bakers' wares"],
    "찰떡": ["rice cake", "cakes", "pastry", "bakers wares", "bakers' wares"],
    "콩찰떡": ["rice cake", "cakes", "pastry", "bakers wares", "bakers' wares"],
    ...
    "골뱅이무침": ["food preparations not elsewhere specified or included", "other food preparations", "miscellaneous edible preparations", "prepared meal", "prepared food"],
    "꼬막무침": ["food preparations not elsewhere specified or included", "other food preparations", "miscellaneous edible preparations", "prepared meal", "prepared food"],
    "멍게무침": ["food preparations not elsewhere specified or included", "other food preparations", "miscellaneous edible preparations", "prepared meal", "prepared food"],
    "미역줄기볶음": ["food preparations not elsewhere specified or included", "other food preparations", "miscellaneous edible preparations", "prepared meal", "prepared food"],
    "무침류": ["food preparations not elsewhere specified or included", "other food preparations", "miscellaneous edible preparations", "prepared meal", "prepared food"],
    "누룽지": ["prepared foods of rice", "prepared cereals", "cereal preparations", "rice"],
    "영양밥": ["prepared foods of rice", "prepared cereals", "cereal preparations", "rice"],
    "전복죽": ["prepared foods of rice", "prepared cereals", "cereal preparations", "rice"],
    "약과": ["bakers wares", "bakers' wares", "pastry", "cakes"],
    "호두과자": ["bakers wares", "bakers' wares", "pastry", "cakes"],
    ...
    "생선": ["fish"],
    "대구": ["cod", "gadus", "gadus morhua", "gadus macrocephalus", "fish", "prepared fish", "preserved fish"],
    "어류": ["fish"],
    "어묵": ["surimi", "fish paste"],
    "어묵바": ["surimi", "fish paste", "fish meat", "prepared fish", "prepared preserved fish"],
    "어육": ["fish meat", "minced fish", "surimi", "prepared fish"],
    ...
    "조개": ["molluscs"],
    "국수": ["noodle", "pasta"],
    "파스타": ["pasta", "spaghetti", "macaroni", "noodles"],
    "생면": ["uncooked pasta", "fresh pasta", "pasta", "noodles"],
    "떡볶기": ["rice cake", "rice cakes", "rice pasta", "pasta", "noodles"],
    "인절미": ["injeolmi", "glutinous rice cake", "rice cake", "prepared rice cake", "ready to eat rice cake", "bakers wares", "cakes"],
    "떡류": ["rice cake", "rice cakes", "rice pasta", "prepared rice cake", "cakes"],
    "빵류": ["bread", "pastry", "bakers wares", "bakers' wares", "cakes"],
    "빵": ["bread", "pastry", "bakers wares", "bakers' wares"],
    "계란빵": ["bread", "pastry", "cakes", "bakers wares", "bakers' wares"],
    "해물파전": ["pastry", "bakers' wares", "flour", "starch", "cereals"],
    "파전": ["pastry", "bakers' wares", "flour", "starch", "cereals"],
    "부침개": ["pastry", "bakers' wares", "flour", "starch", "cereals"],
    "부침": ["pastry", "bakers' wares", "flour", "starch", "cereals"],
    "전류": ["pastry", "bakers' wares", "flour", "starch", "cereals"],
    "밀가루": ["flour"],
    "라면": ["noodle", "pasta"],
    "우동": ["noodle", "pasta"],
    "냉우동": ["noodle", "pasta"],
    "비빔메밀": ["noodle", "pasta"],
    "면류": ["noodle", "pasta"],
    "밀면": ["noodle", "noodles", "pasta"],
    "막국수": ["noodle", "buckwheat", "cereal"],
    "메밀": ["buckwheat", "cereal"],
    "솥밥": ["rice", "cooked rice", "prepared rice", "rice meal", "pre-cooked rice", "prepared foods of rice"],
    "소스": ["sauce"],
    "게장": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "간장게장": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "양념게장": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "강된장": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "김자반": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "젓갈": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "창난젓": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "날치알": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "콩자반": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "장아찌": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "고추장": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "약고추장": ["sauce", "sauces", "mixed condiment", "mixed condiments", "mixed seasoning", "mixed seasonings"],
    "소면": ["uncooked pasta", "pasta not stuffed", "pasta", "noodles"],
    "절편": ["rice cake", "cakes", "pastry", "bakers wares", "bakers' wares"],
    "가래떡": ["rice cake", "cakes", "pastry", "bakers wares", "bakers' wares"],
    "떡국": ["prepared foods of rice", "prepared cereals", "cereal preparations", "rice"],
    "코다리조림": ["prepared fish", "preserved fish", "prepared preserved fish"],
    "장어구이": ["grilled fish", "prepared fish", "preserved fish"],
    "연어장": ["salmon", "prepared fish", "preserved fish"],
    "멸치조림": ["anchovies", "prepared fish", "preserved fish"],
    "물회": ["prepared fish", "preserved fish"],
    "전복장": ["abalone", "molluscs", "prepared molluscs", "prepared or preserved molluscs"],
    "전복 버터구이": ["abalone", "molluscs", "prepared molluscs", "prepared or preserved molluscs"],
    "코다리양념조림": ["prepared fish", "preserved fish", "prepared preserved fish"],
    "황태구이": ["prepared fish", "preserved fish", "prepared preserved fish"],
    "간짜장": ["other pasta", "prepared pasta", "prepared noodles", "pasta", "noodles"],
    "쟁반짜장": ["other pasta", "prepared pasta", "prepared noodles", "pasta", "noodles"],
    "라볶이": ["other pasta", "prepared pasta", "prepared noodles", "pasta", "noodles", "prepared meal", "prepared food"],
    "초콜릿": ["chocolate"],
    ...
    def _BuildExpandedSearchTerms(self, searchText: str) -> Set[str]:
        ...
        for sourceTerm, expandedTerms in TERM_EXPANSION_MAP.items():
            ...
            for expandedTerm in expandedTerms:
                normalizedExpandedTerm = NormalizeWhiteSpace(expandedTerm).lower()
                if normalizedExpandedTerm:
                    terms.add(normalizedExpandedTerm)
    ...
    def _BuildDefaultUserPrompt(
        ...
        return "\n".join(
            [
                ...
                "candidate_reviews[].reason은 사용자가 이해하기 쉬운 한국어 자연어 문장으로 작성하라.",
